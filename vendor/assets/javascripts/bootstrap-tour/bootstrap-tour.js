  ...
  Tour = (function() {
    function Tour(options) {
      this._options = $.extend({
        ...
        duration: false,
        basePath: "",
        template: "<div class='popover'> <div class='arrow'></div> <h3 class='popover-title'></h3> <div class='popover-content'></div> <div class='popover-navigation'> <div class='btn-group'> <button class='btn btn-sm btn-default' data-role='prev'>&laquo; Atr&acute;s</button> <button class='btn btn-sm btn-default' data-role='next'>Siguiente &raquo;</button> <button class='btn btn-sm btn-default' data-role='pause-resume' data-pause-text='Pause' data-resume-text='Resume'>Parar</button> </div> <button class='btn btn-sm btn-default' data-role='end'>Fin</button> </div> </div>",
